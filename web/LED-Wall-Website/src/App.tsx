...
function App(){
  ...
  return(
    <div className={styles.canvas}>
      <Element url="https://imgs.search.brave.com/vzVb420qkaR-r4_3HMcbvH5eNniSvO1Ieq69YJzhYxY/rs:fit:500:0:1:0/g:ce/aHR0cHM6Ly9pLmlt/Z2ZsaXAuY29tLzQv/M3UwNGg1LmpwZw" size={100}/>
