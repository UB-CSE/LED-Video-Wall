...
export const { setGamma, setSelectedElement, addElement, reorderElements, clearElement, updateElement, resetState, updateLocation, toggleElementVisibility } = configSlice.actions;export default configSlice.reducer;